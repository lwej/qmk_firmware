 ...
 */
 ...
 [_QWERTY] = LAYOUT(
  KC_ESC,   KC_1,   KC_2,    KC_3,    KC_4,    KC_5,                     KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    TD(T_BSPC),
 ...
 */
 [_LOWER] = LAYOUT(
  ...
  _______,   SE_EXLM,  SE_DQUO,  SE_HASH,  SE_DLR,  SE_PERC,                   SE_AMPR,  SE_SLSH,  SE_LPRN,  SE_RPRN,  SE_EQL,   KC_DEL,
  _______,   SE_LPRN,  SE_RPRN,  SE_LCBR,  SE_RCBR, SE_ARNG,                   KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  KC_GRV,   SE_ASTR,
  SE_PIPE,   SE_LBRC,  SE_RBRC,  SE_SLSH,  SE_BSLS, SE_ASTR, XXXXXXX, XXXXXXX, KC_C_L,   KC_C_R,   SE_LABK,  SE_RABK,  SE_PLUS,  RSFT_T(KC_SPC),
...
*/
 ...
 [_RAISE] = LAYOUT(
TD(T_ESC),  SE_ACUT,  SE_AT,   SE_GRV, _______, _______,                      SE_CIRC, _______, _______, _______, _______, SE_SECT,
  _______,  _______, _______, _______, _______, _______,                      _______, KC_BTN1, KC_BTN2, _______, _______, SE_TILD,
  _______,  SE_ACUT,  SE_AT,  SE_GRV,  KC_RBRC, SE_QUOT,                      KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, _______, _______,
  SE_PIPE,  _______, _______, _______, _______, SE_ASTR, XXXXXXX,    XXXXXXX, KC_WH_L, KC_WH_D, KC_WH_U, KC_WH_R, _______, _______,
...
tap_dance_action_t tap_dance_actions[] = {
    ...
    [T_BSPC] = ACTION_TAP_DANCE_DOUBLE(KC_BSPC, SE_TILD)
};
