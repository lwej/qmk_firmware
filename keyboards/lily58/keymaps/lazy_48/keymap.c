...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
   [_LOWER] = LAYOUT(
    ...
    _______,   SE_LBRC,  SE_RBRC,  SE_SLSH,  SE_BSLS, SE_ASTR, XXXXXXX, XXXXXXX, KC_C_L,   KC_C_R,   SE_LABK,  SE_RABK,  SE_PLUS,  RSFT_T(KC_SPC),
  ...
  */
   ...
   [_RAISE] = LAYOUT(
    ...
    SE_PIPE,  KC_ESC,  KC_RGUI, KC_RALT, SE_CIRC, SE_QUOT, XXXXXXX, XXXXXXX,   KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,
  ...
  */
  [_ADJUST] = LAYOUT(
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
  QK_BOOT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                    _______,  KC_BTN1, KC_BTN2, _______, _______, _______,
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                    KC_MS_L,  KC_MS_D,  KC_MS_U, KC_MS_R, _______,_______,
  _______,  SE_ACUT,  SE_AT,  SE_GRV,  KC_RBRC, SE_QUOT, XXXXXXX, XXXXXXX, KC_WH_L, KC_WH_D, KC_WH_U, KC_WH_R, _______, _______,
